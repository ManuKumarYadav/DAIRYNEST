...
const OrderStatus = () => {
  ...
  return (
    <div className="status-page">
      ...
      <div style={{ padding: "90px clamp(12px,4vw,40px) 0" }}>
...
const Style = () => (
  ...
  *{margin:0;padding:0;box-sizing:border-box;font-family:"Poppins",sans-serif;}
  ...
  .bg{position:absolute;border-radius:50%;filter:blur(100px);opacity:0.2;pointer-events:none !important;z-index:0;}
  ...
  .empty-card{text-align:center;padding:50px 30px;max-width:500px;margin:100px auto;position:relative;z-index:2;}
  .empty-icon{font-size:48px;margin-bottom:16px;}
  .empty-card h1{font-size:32px;color:#0b57a4;margin-bottom:12px;}
  .empty-card p{color:#64748b;margin-bottom:24px;}
  .shop-btn{padding:14px 28px;border-radius:12px;background:linear-gradient(135deg,#0b57a4,#0878b8);color:#fff;font-weight:700;border:none;cursor:pointer;}
